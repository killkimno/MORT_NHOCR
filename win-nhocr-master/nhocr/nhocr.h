...
class NHrec {
    ...
    int	rec_addstr(wchar_t *line, const wchar_t *str, int bufsize);
    ...
    int	rec_gramd_solve(wchar_t *buffer, size_t size);
    ...
    int	rec_line(SIPImage *image, wchar_t *resultline, int bufsize);
